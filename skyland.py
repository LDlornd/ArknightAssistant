...
# 获取角色信息的 url
get_player_info_url = "https://zonai.skland.com/api/v1/game/player/info"
...
def get_user_info(uid):
    ...
    resp = requests.get(get_player_info_url, headers=get_sign_header(f"{get_player_info_url}?uid={uid}", 'get', None, http_local.header), params=params).json()
